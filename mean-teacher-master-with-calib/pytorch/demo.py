...
import argparse
from mean_teacher.architectures import ResNet32x32,ShakeShakeBlock
...
def demo(data, save, depth=40, growth_rate=12, batch_size=16):
    ...
    model_filename = os.path.join(save, 'best.ckpt')
    ...
    #change model here -create same model used earlier
    orig_model =  ResNet32x32(ShakeShakeBlock,
                        layers=[4, 4, 4],
                        channels=96,
                        downsample='shift_conv',num_classes=no_classes)
